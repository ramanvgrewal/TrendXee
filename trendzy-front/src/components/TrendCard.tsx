  ...
  return (
    ...
    >
      <div className={`relative w-full overflow-hidden ${fill ? "min-h-0 flex-1" : "aspect-[4/5]"}`}>
        ...
        />
        <div className="absolute left-4 top-4 z-20 rounded-full bg-[oklch(0.72_0.09_55)] px-3 py-1.5 font-mono text-[10px] font-bold uppercase tracking-[0.24em] text-background">
          The Underdog
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="relative aspect-square w-full overflow-hidden">
        ...
        />
        <div className="absolute left-2 top-2 z-20 rounded-full bg-background/75 px-2 py-0.5 font-mono text-[9px] font-bold uppercase tracking-[0.2em] text-foreground/80 backdrop-blur">
          {sourceLabels[source]}
        </div>
      </div>
      <div className="flex flex-1 flex-col gap-1 p-3">
        <div>
          ...
          <div className="font-mono text-[8px] uppercase tracking-[0.2em] text-[oklch(0.72_0.09_55)]">on {sourceLabels[source]}</div>
        </div>
